...
BLOG_AUTHOR = "LJFP"  # (translatable)
BLOG_TITLE = "Un Caballo de Abdera"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://ljfp.xyz/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://ljfp.xyz/"
BLOG_EMAIL = "ljfp@ljfp.xyz"
BLOG_DESCRIPTION = "Desvaríos de un paquidermo parlante."  # (translatable)
...
# is in the manual.
COMMENT_SYSTEM_ID = "https://ljfp.xyz"
